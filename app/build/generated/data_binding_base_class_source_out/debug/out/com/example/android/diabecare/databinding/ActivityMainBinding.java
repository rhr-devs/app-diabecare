...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomAppBar bottomAppBar, @NonNull CoordinatorLayout coordinatorLayout,
      @NonNull FloatingActionButton floatingBtn, @NonNull MaterialToolbar toolbar) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bottomAppBar, coordinatorLayout,
          floatingBtn, toolbar);
    }
